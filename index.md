...
Course communication will be conducted through Piazza, please join via this [**link**](https://piazza.com/buffalo/spring2026/cse589).

For **Access Code**: You should find it under the Announcements tab in **UBLearns Brightspace**.
...
- No tolerance on cheating!
	...
	-Fail the course on any lab, project, or exam violation even for first offense.
...
- Any student may withdraw their submission (lab, project) any time, no questions asked, BEFORE any AI violation is discovered.

## AI Tools

AI tools may be used to help you **learn** — for example, to understand concepts, clarify lecture material, or explain error messages.
- AI tools (ChatGPT, Google Gemini, etc.) may NOT be used to write, generate, or complete any part of your Course Project code or submissions.
- Any code you submit must be your own, unassisted work. Use of AI-generated code in the project will be treated as an academic integrity violation.
